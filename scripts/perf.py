...
def performance(args):
    ...
    env = MEnv(policy, other_policy, n_env_parallel=1, n_torch_parallel=2, max_env_num=300, max_batch_size=20000, max_eps=3000)
    env.collect(eval=True, verbose=(not args.quiet), varity=args.varity)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-va', '--varity', type=int, default=2147483647)
